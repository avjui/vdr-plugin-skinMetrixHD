...
OBJS = imageloader.o baserender.o displaychannel.o displaymenu.o displaymessage.o \
	   displayreplay.o displaytracks.o displayvolume.o metrixhd.o $(PLUGIN).o
...
install-themes:
	...
	cp -rf themes/* $(DESTDIR)$(VDRCONFDIR)/themes
...
install-ttf:
	cp -r ttf/* /usr/share/fonts/truetype/freefont

install: install-lib install-i18n install-themes install-icons install-ttf
